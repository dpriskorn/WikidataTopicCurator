...
#         excluded_item_count=results.number_of_excluded_items,
#         article_rows=results.get_item_suggestion_html_rows(),
#         excluded_article_rows=results.get_excluded_item_suggestion_html_rows(),
#         qid=qid,
#         label=label,
#         description=description,
#         link=topic.url,
